...
if __name__ == "__main__":
    ...
    parser.add_argument('--trace_path', type=str, default="", help="The size parameter, default is 100.")
    parser.add_argument('--trace_info', type=str, default="", help="The size parameter, default is 100.")
